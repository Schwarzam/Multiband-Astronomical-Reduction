...
def py_apply_mask(indat, pixelmask, inmask=None, cleantype='idw',
    ...
    # Inverse distance weighted interpolation
        ...
        py_clean_idwinterpolate(cleanarr, pixmask, mask, nx, ny)
    else:
...
def py_clean_idwinterpolate(cleanarr, crmask, mask, nx, ny):
...
def py_clean_meanmask(cleanarr, pixmask, mask, nx, ny):
...
def py_clean_medmask(cleanarr, pixmask, mask, nx, ny):
